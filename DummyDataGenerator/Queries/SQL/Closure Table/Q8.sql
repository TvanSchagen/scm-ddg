SELECT organization.name, organization.email_address, location.country, location.city, product.name, activity.name
FROM supplies
...
AND location.longtitude > -30 
AND location.longtitude < 70